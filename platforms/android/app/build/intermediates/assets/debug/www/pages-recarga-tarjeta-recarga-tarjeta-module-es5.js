(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-recarga-tarjeta-recarga-tarjeta-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecargaTarjetaPageRoutingModule = /** @class */ (function () {
                function RecargaTarjetaPageRoutingModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecargaTarjetaPageModule = /** @class */ (function () {
                function RecargaTarjetaPageModule() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecargaTarjetaPage = /** @class */ (function () {
                function RecargaTarjetaPage(_methodsApiRestService) {
                    this._methodsApiRestService = _methodsApiRestService;
                    this.cuentas = [];
                    this.cedula = null;
                    this.dinero = 0;
                }
                RecargaTarjetaPage.prototype.ngOnInit = function () {
                    this.cedula = localStorage.getItem('cedula');
                    this.service('/cuentas/cuentasList/' + this.cedula);
                };
                RecargaTarjetaPage.prototype.service = function (endpoint) {
                    var _this = this;
                    this._methodsApiRestService.GetMethod(endpoint)
                        ...
                        if (typeof response[0] === 'undefined' || response[0] === null) {
                            ...
                            var _loop_1 = function (x) {
                                _this._methodsApiRestService.GetMethod('/aliados/valuePunto/' + response[x].aliado_id)
                ...
                RecargaTarjetaPage.prototype.recargar = function () {
            ...
            RecargaTarjetaPage.ctorParameters = function () { return [
