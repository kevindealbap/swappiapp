        ...
        value: function service(endpoint, params) {
          ...
          this._methodsApiRestService.PostMethod(endpoint, params).subscribe(function (response) {
            if (response) {
              ...
              _this.mensaje = response['message'];
              sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire("Evento de Aplicacion", _this.mensaje, "error");
            }
          }, function (error) {
            if (error.status === 406) {
              sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire("Ups!", "Ya existe una cuenta vinculada", "warning");

              _this.navCtrl.navigateRoot('/inicio');
            }

            if (!error.ok && error.status === 422) {
              sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire("Evento de Aplicacion!", error.error.message, "error");
